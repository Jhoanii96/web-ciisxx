		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<?php
						if ($data['fotoUsu'] == '/2019/src/assets/media/image/') {
							echo '<img src="/2019/src/assets/media/image/avatar-male3.png" class="user-image" alt="User Image">';
						} else {
							echo '<img src="' . $data['fotoUsu'] . '" class="user-image" alt="User Image">';
						}
						?>
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header">
							...
							if ($data['fotoUsu'] == '/2019/src/assets/media/image/') {
								...
								echo '<img src="' . $data['fotoUsu'] . '" class="img-circle" alt="User Image">';
							}
							?>
							<p>
								<?= $data['nombre'] . ' ' . $data['apellido'] ?>
								<small style="margin-top: 7px; font-size: 14px;"><?= $data['rol'] ?></small>
							</p>
						</li>
						<!-- Menu Footer-->
...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<div class="user-panel" style="padding-left: 7px;">
			...
			<div class="pull-left info" style="padding-top: 0px; padding-bottom: 0px; top: 0px; bottom: 0px; width: 170px; padding-left: 0px; padding-right: 0px; margin-left: 5px;">
				<div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); display: block; width: 100%;">
					<p style="white-space: normal; font-size: 12px; margin-bottom: 6px;"><?= $data['nombre'] . ' ' . $data['apellido'] ?></p>
					<small><?= $data['rol'] ?></small>
				</div>
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li>
				<a href="javascript:void(0);">
					<i class="fa fa-check-square-o"></i> <span>Asistencias</span>
				</a>
			</li>
			<li>
				<a href="javascript:void(0);">
					<i class="fa fa-trophy"></i> <span>Premios</span>
				</a>
			</li>
			<li>
				<a href="javascript:void(0);">
					<i class="fa fa-tv"></i> <span>Resultado Competencias</span>
				</a>
			</li>
		</ul>
	</section>
